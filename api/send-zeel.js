...
export default async function handler(req, res) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, X-Test-Recipient')
  ...
  const testRecipient = req.headers['x-test-recipient']
  const toEmail = testRecipient ? testRecipient.trim() : getToEmail(branch)
  if (!toEmail) {
